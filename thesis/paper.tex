...
%
% Wnioski do przepisania, napisać że widać wyraźny trend wskazujący na powodzenie procesu nauczanie jednak nie jest on tak wydajny jakbym chciał. Poszukać możliwych punktów powodujących problemy(optymalizacja, implementacja operatorów). Wspomnieć o innycyh realizacjach tego pomysłu i ich wynikach.
%
