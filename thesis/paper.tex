...
\begin{figure}[h]
	...
	\caption{Reprezentacja danych wejściowych na podstawie widoku z głowy węża. Poszczególne linie (zółte, fioletowe i pomarańczowe) są reprezentacjami tego co widzi wąż.}
